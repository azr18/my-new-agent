# My New Agent - Brand Voice Reference

This is the canonical brand voice for My New Agent (mynewagent.ai). All skills reference this file when generating agency-authored content. It also serves as a worked example of the brand voice profile format.
...
| Gold (highlights, key numbers) | #FFD700 |
| Heading Font | Calibri (presentations) / Inter (web) |
| Body Font | Inter (web) / Calibri (presentations) |
| Style | Excalidraw hand-drawn aesthetic, dark canvas, dot grid |
